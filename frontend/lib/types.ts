...
export type RequirementScopeItemResponse = components["schemas"]["RequirementScopeItemResponse"];
export type RequirementScopeListResponse = components["schemas"]["RequirementScopeListResponse"];
...
export type ApplicabilityBatchReviewRequest = components["schemas"]["ApplicabilityBatchReviewRequest"];
export type ApplicabilityBatchReviewResponse = components["schemas"]["ApplicabilityBatchReviewResponse"];
...
export type ActionPriority = components["schemas"]["ActionPriority"];
...
export type ExportVersion = components["schemas"]["ExportVersionResponse"];
export type ExportFileResponse = components["schemas"]["ExportFileResponse"];
export type GenerateExportRequest = components["schemas"]["GenerateExportRequest"];

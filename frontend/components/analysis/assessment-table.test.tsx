...
describe("AssessmentTable", () => {
  ...
  it("shows business labels for the complete assessment list", async () => {
    ...
    expect(screen.getByText("第 1–50 条，共 577 条")).toBeInTheDocument();
    ...
    expect(screen.getByText("第 551–577 条，共 577 条")).toBeInTheDocument();

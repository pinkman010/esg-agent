...
截至 2026-08-17，当前正式发布基线为 `v1.3`，后端包、前端包和 OpenAPI `info.version` 统一为 `1.3.0`。运行时 OpenAPI 的 40 条 `/api/*` 路径已全部同步到 `frontend/lib/generated/api-types.ts`，其中包括 `GET /api/capabilities/ocr`。

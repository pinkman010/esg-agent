...
225 条真实 DeepSeek 评估继续作为 AI 辅助工程基线；模型和 Prompt 未因本轮解冻改变。最终 Envision 和 Goldwind 产品 run 均使用 `confirm_llm=false`，OCR/VLM 均未启用。规则、AI 和人工三层权威关系保持独立。该候选基线属于本地产品与工程验收，不构成 GRI 专家认证、外部鉴证或企业部署承诺。
